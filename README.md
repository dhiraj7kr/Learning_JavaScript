...
Here's a version of your README file with the requested additions, including follow buttons for Instagram, Twitter, GitHub, Medium, and LinkedIn with real-time follower counts (the real-time follower counts would need to be integrated through API calls, but I’ve added placeholders where this can be implemented):

---

<h1 align="center">  
  <br>  
  <a href="https://github.com/dhiraj7kr/Learning_JavaScript"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/JavaScript-logo.png/900px-JavaScript-logo.png" alt="JavaScript" width="200" /></a>  
  <br>  
  <br>  
...
This repository was created to help developers master their concepts in JavaScript. It is not a requirement, but a guide for future studies. It is based on an article written by Stephen Curtis, and you can read it [here](https://medium.com/@dhiraj7kr/).

**🚀 Considered by GitHub as one of the [top open source projects of 2018!](https://blog.github.com/dhiraj7kr/Learning_JavaScript/)**

## Community  

You can submit a PR by adding a link to your recaps or reviews. If you want to translate the repo into your native language, please feel free to do so.
...
Feel free to contribute, star this repository, or share it with others in the community. Let's grow together as JavaScript developers!
...
This software is licensed under MIT License, See [License](https://github.com/dhiraj7kr/) for more information ©Dhiraaj Kumar.
